...
This is a docs-symmetry placeholder for a defense that already exists in skill prose. Future contributors should be aware: the skill is enforcing a phishing-approval defense whose threat class is documented here, even though no MCP-side code change is needed to enable it.

  ...
  const lines = [
    ...
    ...(args.decoderUrl
      ? [
          ...
          "         user has a clickable fallback without scrolling. Render",
          "         the URL as a Markdown hyperlink — do NOT paste the raw",
          "         URL (swiss-knife calldata URLs are multi-KB and wrap",
          "         the chat into unreadable hex).]",
